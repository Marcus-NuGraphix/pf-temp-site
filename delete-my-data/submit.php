...
const DELETE_REQUEST_TO = 'delete@portugueseforum.org.za';
const MAIL_FROM = 'no-reply@portugueseforum.org.za';
const SITE_HOST = 'portugueseforum.org.za';
const DELETE_FORM_ENABLED = true;
...
$subject = 'Delete My Data Request - portugueseforum.org.za [' . $referenceId . ']';
...
function resolveRateLimitDirectory(): string
{
  ...
  $fallback = rtrim(sys_get_temp_dir(), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'pf-delete-request-rate-limit';
